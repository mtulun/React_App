                    ...
                    <br />
                    {
                        menus.map((item, key) => {
                            ...
                            return (
                                <>
                                    <h4>{item.name}</h4>
                                    {item.price > 8 ? <p className="w3-text-grey">{item.description} <span style={{color:'red'}}>{item.price}</span></p> : <p className="w3-text-grey">{item.description} <span>{item.price}</span></p>}
                                    <br />
                                </>
                            )
                        })
